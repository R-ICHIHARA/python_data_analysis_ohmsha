...
standard_regression_coefficients = pd.DataFrame(
    model.coef_, index=x_train.columns, columns=["standard_regression_coefficients"]
)
...
print(
    "MAE for training data :", metrics.mean_absolute_error(y_train, estimated_y_train)
)
...
print(
    "RMSE for test data :", metrics.mean_squared_error(y_test, estimated_y_test) ** 0.5
)
